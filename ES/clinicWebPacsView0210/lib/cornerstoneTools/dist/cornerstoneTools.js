...
var _getHandleNearImagePoint = __webpack_require__(20);
...
var _touchMoveHandle = __webpack_require__(57);
...
var _touchMoveAllHandles = __webpack_require__(56);
...
var _pointInsideBoundingBox = __webpack_require__(10);
...
exports.default = function (canvas, eventData, targetElement, referenceElement) {
  ...
  var currentIndex = stack.currentImageIdIndex + 1;

  //  Draw text
  var text = String(currentIndex);

  var coords = { // Translate the x/y away from the cursor
...
var _loadHandlerManager = __webpack_require__(7);
...
var _getOrientationString = __webpack_require__(69);

var _getOrientationString2 = _interopRequireDefault(_getOrientationString);

var _invertOrientationString = __webpack_require__(70);
...
var _requestPoolManager = __webpack_require__(21);
...
var _multiTouchDragTool = __webpack_require__(23);
...
exports.default = function (element, newImageIdIndex) {
  ...
  var endLoadingHandler = _loadHandlerManager2.default.getEndLoadHandler();
  var errorLoadingHandler = _loadHandlerManager2.default.getErrorLoadingHandler();
  var stackscrollSynchronizer = new _Synchronizer2.default('CornerstoneStackScroll', _layoutStackScrollSynchronizer2.default);
  ...
  // Retry image loading in cases where previous image promise
  // Was rejected, if the option is set
  var config = _layoutStackScroll.layoutStackScroll.getConfiguration();
...
var _layoutStackScroll = __webpack_require__(46);

var _triggerEvent = __webpack_require__(3);

var _triggerEvent2 = _interopRequireDefault(_triggerEvent);

var _Synchronizer = __webpack_require__(48);

var _Synchronizer2 = _interopRequireDefault(_Synchronizer);

var _layoutStackScrollSynchronizer = __webpack_require__(49);

var _layoutStackScrollSynchronizer2 = _interopRequireDefault(_layoutStackScrollSynchronizer);
...
exports.layoutStackScrollMultiTouch = exports.layoutStackScrollTouchDrag = exports.layoutStackScrollWheel = exports.layoutStackScroll = undefined;
...
var _layoutScroll = __webpack_require__(47);

var _layoutScroll2 = _interopRequireDefault(_layoutScroll);
...
function mouseWheelCallback(e, eventData) {
  ...
  var config = layoutStackScroll.getConfiguration();
  ...
  (0, _layoutScroll2.default)(eventData.element, images, loop);
}
...
function dragCallback(e, eventData) {
  ...
  if (Math.abs(e.data.deltaY) >= pixelsPerImage) {
    ...
    e.data.deltaY = imageDeltaMod;
    (0, _layoutScroll2.default)(element, imageIdIndexOffset);
  }
...
// Module/private exports
var layoutStackScroll = (0, _simpleMouseButtonTool2.default)(mouseDownCallback);
var layoutStackScrollWheel = (0, _mouseWheelTool2.default)(mouseWheelCallback);
...
var layoutStackScrollTouchDrag = (0, _touchDragTool2.default)(dragCallback, options);

function multiTouchDragCallback(e, eventData) {
  var config = layoutStackScrollTouchDrag.getConfiguration();
...
var layoutStackScrollMultiTouch = (0, _multiTouchDragTool2.default)(multiTouchDragCallback, options);

layoutStackScrollMultiTouch.setConfiguration(configuration);

exports.layoutStackScroll = layoutStackScroll;
exports.layoutStackScrollWheel = layoutStackScrollWheel;
exports.layoutStackScrollTouchDrag = layoutStackScrollTouchDrag;
exports.layoutStackScrollMultiTouch = layoutStackScrollMultiTouch;
...
exports.default = function (element, images, loop) {
  loop = loop || false;
  var $ = _externalModules2.default.$;
  var toolData = (0, _toolState.getToolState)(element, 'stack');
  ...
  (0, _layoutScrollToIndex2.default)(element, newImageIdIndex);
};
...
var _layoutScrollToIndex = __webpack_require__(45);

var _layoutScrollToIndex2 = _interopRequireDefault(_layoutScrollToIndex);
...
function Synchronizer(event, handler) {
  ...
  function fireEvent(sourceElement, eventData) {
    ...
    targetElements.forEach(function (targetElement) {
      ...
      // If($(targetElement).data("autoPlanePosition")) {  //thy--autoPlanePosition add a custom data-attribute
...
exports.default = function (synchronizer, sourceElement, targetElement, eventData) {
  ...
  var targetImageIndex = $(targetElement).data('layoutIndex');
  ...
  loader.then(function (image) {
    ...
    console.log($(targetElement).data('layoutIndex'))
    if (endLoadingHandler) {
...
Object.defineProperty(exports, 'layoutScrollToIndex', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_layoutScrollToIndex).default;
  }
});
...
Object.defineProperty(exports, 'layoutScroll', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_layoutScroll).default;
  }
});
...
var _drawArrow = __webpack_require__(53);
...
var _calculateEllipseStatistics = __webpack_require__(54);
...
var _probeTool4D = __webpack_require__(71);
...
var _timeSeriesPlayer = __webpack_require__(74);
...
var _timeSeriesScroll = __webpack_require__(75);
...
var _wwwcSynchronizer = __webpack_require__(76);
...
var _updateImageSynchronizer = __webpack_require__(77);
...
var _stackScrollSynchronizer = __webpack_require__(78);
...
var _stackImagePositionSynchronizer = __webpack_require__(79);
...
var _stackImagePositionOffsetSynchronizer = __webpack_require__(80);
...
var _stackImageIndexSynchronizer = __webpack_require__(81);
...
var _panZoomSynchronizer = __webpack_require__(82);
...
var _rotationSynchronizer = __webpack_require__(83);
...
var _automaticPlanePositioningSynchronizer = __webpack_require__(84);
...
var _timeSeriesSpecificStateManager = __webpack_require__(86);
...
var _stackSpecificStateManager = __webpack_require__(87);
...
var _frameOfReferenceStateManager = __webpack_require__(88);
...
Object.defineProperty(exports, 'layoutStackScroll', {
  enumerable: true,
  get: function get() {
    return _layoutStackScroll.layoutStackScroll;
  }
});
Object.defineProperty(exports, 'layoutStackScrollWheel', {
  enumerable: true,
  get: function get() {
    return _layoutStackScroll.layoutStackScrollWheel;
  }
});
Object.defineProperty(exports, 'layoutStackScrollTouchDrag', {
  enumerable: true,
  get: function get() {
    return _layoutStackScroll.layoutStackScrollTouchDrag;
  }
});
Object.defineProperty(exports, 'layoutStackScrollMultiTouch', {
  enumerable: true,
  get: function get() {
    return _layoutStackScroll.layoutStackScrollMultiTouch;
  }
});
...
var _scrollIndicator = __webpack_require__(92);
...
var _stackRenderers = __webpack_require__(93);
...
var _playClip = __webpack_require__(95);
...
var _keyboardInput = __webpack_require__(96);
...
var _mouseInput = __webpack_require__(97);
...
var _mouseWheelInput = __webpack_require__(98);
...
var _preventGhostClick = __webpack_require__(58);
...
var _touchInput = __webpack_require__(99);
...
var _angleTool = __webpack_require__(100);
...
var _arrowAnnotate = __webpack_require__(101);
...
var _crosshairs = __webpack_require__(102);
...
var _doubleTapTool = __webpack_require__(59);
...
var _doubleTapZoom = __webpack_require__(103);
...
var _dragProbe = __webpack_require__(104);
...
var _ellipticalRoi = __webpack_require__(105);
...
var _freehand = __webpack_require__(106);
...
var _highlight = __webpack_require__(107);
...
var _imageStats = __webpack_require__(108);
...
var _keyboardTool = __webpack_require__(55);
...
var _magnify = __webpack_require__(110);
...
var _mouseButtonRectangleTool = __webpack_require__(60);
...
var _orientationMarkers = __webpack_require__(111);
...
var _panMultiTouch = __webpack_require__(113);
...
var _probe = __webpack_require__(114);
...
var _rectangleRoi = __webpack_require__(115);
...
var _rotate = __webpack_require__(116);
...
var _rotateTouch = __webpack_require__(117);
...
var _saveAs = __webpack_require__(118);
...
var _touchPinchTool = __webpack_require__(61);
...
var _referenceLinesTool = __webpack_require__(67);

var _referenceLinesTool2 = _interopRequireDefault(_referenceLinesTool);

var _automaticPlanePositioningTool = __webpack_require__(68);
...
var _measurementManager = __webpack_require__(72);

var _measurementManager2 = _interopRequireDefault(_measurementManager);

var _lineSampleMeasurement = __webpack_require__(73);
...
exports.default = function (synchronizer, sourceElement, targetElement, eventData) {
  ...
  var automaticPlanePositioning = (0, _calculateAutomaticPlanePositioning2.default)(stackData, sourceImagePlane, targetImagePlane);
...
var _calculateAutomaticPlanePositioning = __webpack_require__(85);
...
exports.default = function (stack, sourceImagePlane, targetImagePlane) {
  ...
  var automaticPlanePositioningIndex = void 0;
...
var _fusionRenderer = __webpack_require__(94);
...
function playClip(element, framesPerSecond) {
  ...
  var playClipAction = function playClipAction() {
    ...
    if (!playClipData.loop && (newImageIdIndex < 0 || newImageIdIndex >= imageCount)) {
      ...
      var toolPlay = document.getElementsByClassName("tool-play")[0]; //ljq play-loop-stop
...
var _brushTool = __webpack_require__(62);

var _brushTool2 = _interopRequireDefault(_brushTool);

var _getCircle = __webpack_require__(63);

var _getCircle2 = _interopRequireDefault(_getCircle);

var _drawBrush = __webpack_require__(64);
