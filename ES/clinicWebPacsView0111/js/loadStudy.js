...
//	var hashStudyId = "1.2.826.0.1.3680043.2.461.9671554.2306841018";//没有数据的测试
	...
	panZoomSynchronizer = new cornerstoneTools.Synchronizers("cornerstoneimagerendered", cornerstoneTools.panZoomSynchronizer);
	wcWwSynchronizer = new cornerstoneTools.Synchronizers("cornerstoneimagerendered", cornerstoneTools.wwwcSynchronizer);
	rotationSynchronizer = new cornerstoneTools.Synchronizers("cornerstoneimagerendered", cornerstoneTools.rotationSynchronizer);
	referenceLineSynchronizer = new cornerstoneTools.Synchronizers("cornerstonenewimage", cornerstoneTools.updateImageSynchronizer);
	synchronizer = new cornerstoneTools.Synchronizers("cornerstonenewimage", cornerstoneTools.automaticPlanePositioningSynchronizer);
