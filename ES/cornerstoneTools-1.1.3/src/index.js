...
export { referenceLines,
  automaticPlanePositioning } from './referenceLines/index.js';
...
export { default as layoutScrollToIndex } from './util/layoutScrollToIndex.js';
export { default as layoutScroll } from './util/layoutScroll.js';
...
export { default as rotationSynchronizer } from './synchronization/rotationSynchronizer.js';
export { default as automaticPlanePositioningSynchronizer } from './synchronization/automaticPlanePositioningSynchronizer.js';
export { default as layoutStackScrollSynchronizer } from './synchronization/layoutStackScrollSynchronizer.js';
...
export { layoutStackScroll,
  layoutStackScrollWheel,
  layoutStackScrollTouchDrag,
  layoutStackScrollMultiTouch } from './stackTools/layoutStackScroll.js';
